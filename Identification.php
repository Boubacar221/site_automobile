...
<html lang="fr">
    ...
    <body class="page_getion" id="page-top">
      ...
      <div>
        ...
        <form method="POST" action="gestion_reserv.php" class="formadmin">
            <h4>Entrez vos Informations</h4>
     <div data-mdb-input-init class="form-outline mb-4">
    <input type="text" name="NOM" id="form1Example1" class="form-control" />
    <label class="form-label" for="form1Example1">Nom & Prenom</label>
  </div>
  <div data-mdb-input-init class="form-outline mb-4">
    <input name="TELEPHONE" type="password" id="form1Example2" class="form-control" />
    <label class="form-label" for="form1Example2">TELEPHONE</label>
  </div>
  <div data-mdb-input-init class="form-outline mb-4">
  ...
  <button data-mdb-ripple-init type="submit" name="connexion" class="btn btn-primary btn-block">Confirmer</button>
