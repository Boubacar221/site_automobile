...
<html lang="fr">
    ...
    <body class="page_getion" id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link" href="Accueil_admin.php">Accueil</a></li>
                        <li class="nav-item"><a class="nav-link" href="Ajout.php">Ajout voiture</a></li>
                        <li class="nav-item"><a class="nav-link" href="collection.php">Rechercher</a></li>
        
                        <li class="nav-item"><a class="nav-link" href="collection.php">ajout admin</a></li>
      ...
      <div>
        ...
        <form method="POST" action="gestion_bolide.php" class="formadmin">
            <h4>Rechercher dans la base de donnée</h4>
  ...
  <button data-mdb-ripple-init type="submit" name="Rechercher" class="btn btn-primary btn-block" title="cliquez pour rechercher">Rechercher</button> <br> <br> 
  <!-- <button data-mdb-ripple-init type="submit" name="Afficher" class="btn btn-primary btn-block">Afficher Toutes les voitures</button>
   -->
